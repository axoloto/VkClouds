...
#define NULL_VEC3 vec3(0.0, 0.0, 0.0)
#define ABS_GRAVITY_ACC_Y 9.81f
#define GRAVITY_ACC vec4(0.0, -ABS_GRAVITY_ACC_Y, 0.0, 0.0)
#define FAR_DIST 1000000.0f

// Domain is a cube of [-1 1] in x y z directions
#define ABS_WALL_X 1.0f
#define ABS_WALL_Y 1.0f
#define ABS_WALL_Z 1.0f
#define MIN_BOUNDS vec3(-ABS_WALL_X, -ABS_WALL_Y, -ABS_WALL_Z)
#define MAX_BOUNDS vec3(ABS_WALL_X, ABS_WALL_Y, ABS_WALL_Z)
